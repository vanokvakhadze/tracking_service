...
export function LoginForm({ deleted }: LoginFormProps) {
  ...
  return (
    <div className="rounded-lg border border-[var(--color-border)] bg-white p-8">
      {deleted ? (
        <div className="mb-5 rounded-md border border-[var(--color-success-border)] bg-[var(--color-success-bg)] p-3 text-[12px] text-[var(--color-success-text)]">
          ანგარიში წაიშალა. მონაცემები 30 დღეში სრულად წაიშლება.
        </div>
      ) : null}
