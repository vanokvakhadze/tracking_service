...
### L1. Vercel deploy (web app + marketing)

**ვის ეკუთვნის:** გიო (30 წუთი) + DNS provider
...
### L2. Codex tasks 047 + 048 დასრულება

**ვის ეკუთვნის:** Codex (პარალელურად)

- [task.047](codex/task.047.md) — `/dashboard` live shifts realtime ✅ ფაილი მზადაა, Codex ჯერ არ შეასრულა
- [task.048](codex/task.048.md) — `/reports` CSV export ✅ ფაილი მზადაა, Codex ჯერ არ შეასრულა

ერთი ბრძანებით ვუსვამთ Codex-ს მთხოვნად — სამივე task აიღოს.
...
### L8. Reviewer demo account

**ვის ეკუთვნის:** გიო (10 წუთი)

Apple + Google reviewer-ები ცდიან app-ის login-ს. წინასწარ შექმენი:
- Email: `review@trackpro.ge`
- Password: შენ აარჩიე (write down)
- Tenant: "App Review Demo"
- 3 location + 2 employee + 1 pending location pre-seeded
